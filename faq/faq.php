      ...
      <div class="pc-container">
        ...
        <nav class="pc-nav">
          <ul class="pc-nav-list">
            ...
            <li class="pc-nav-item">
              <a class="pc-nav-link animsition-link" href=" <?php echo esc_url( home_url('/doctor')); ?>"><span>お知らせ</span></a>
            </li>
            <li class="pc-nav-item">
    ...
    <div class="mobile-menu">
      <nav class="mobile-menu__nav">
        <ul class="mobile-menu__list">
          ...
          <li class="mobile-menu__item">
            <a class="animsition-link" href=" <?php echo esc_url( home_url('/scripts')); ?>">診療内容</a>
          </li>
          <li class="mobile-menu__item">
